...
@if ($navbarItemHelper->isSearch($item))
    ...
    {{-- Search form --}}
    @include('adminlte::components.partials.navbar.menu-item-search-form')
...
@elseif ($navbarItemHelper->isFullscreen($item))
    ...
    @include('adminlte::components.partials.navbar.menu-item-fullscreen-widget')
...
@elseif ($navbarItemHelper->isSubmenu($item))
    ...
    {{-- Dropdown menu --}}
    @include('adminlte::components.partials.navbar.menu-item-dropdown-menu')

@elseif ($navbarItemHelper->isLink($item))

    {{-- Link --}}
    @include('adminlte::components.partials.navbar.menu-item-link')
